                ...
                <Col xs={4}>
                    ...
                    <div>
                        ...
                        <p>Cantidad Agregada {add}</p>
                          ...
                          {add > 0 ? (
                    <Button variant="primary" className="buttonFinalizarCompra"><Link to='/cart'>Finalizar Compra</Link></Button>
                    ) : (
                    <Button variant="primary disabled" className="buttonFinalizarCompra">Finalizar Compra</Button>
                    )}
                    
                   
                  {/* <Button variant="primary" id="buttonFinalizarCompra"><Link to='/cart'>Finalizar Compra</Link></Button>*/} 
